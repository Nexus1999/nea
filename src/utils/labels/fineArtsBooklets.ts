...
export const renderFineArtsBookletsLabels = (
  labels: any[],
  examCode: string,
  examYear: string
): string => {
    ...
    return `
      <div class="label-card">
        ...
        <div class="stats-grid">
          <div class="stat-block finearts-block">
            <div class="stat-header">FINE ARTS BOOKLETS</div>
  ...
  return `
    ...
    <html>
      <head>
        <meta charset="UTF-8" />
        <title>Fine Arts Booklets Labels (2 per page)</title>
        <style>
          * {
            margin: 0;
            padding: 0;
          ...
          .finearts-block {
            border-top: 6px solid #ea580c; /* Orange Accent */
          }
          .bkm-block {
