      ...
      contentHtml = `
        <div class="stats-grid split-grid">
          <div class="stat-block red-block">
            <div class="stat-header font-red">BKM RED (SCHOOL)</div>
            <div class="stat-value text-red">${redQty}</div>
          </div>
          <div class="stat-block pink-block">
            <div class="stat-header font-pink">BKM PINK (PRIVATE)</div>
            <div class="stat-value text-pink">${pinkQty}</div>
          </div>
        </div>
      `;
    } else {
      contentHtml = `
        <div class="stats-grid">
          <div class="stat-block standard-block">
            <div class="stat-header">${itemType} QUANTITY</div>
