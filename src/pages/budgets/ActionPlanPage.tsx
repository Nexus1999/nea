...
const ActionPlanPage = () => {
  ...
  const fetchPlanData = useCallback(async () => {
    ...
    try {
      ...
      // 2. Fetch Routes with Vehicles and STOPS
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          <Button 
            ...
            className="rounded-xl font-bold uppercase text-[10px] tracking-widest h-11 px-6 border-slate-200"
          >
            <MapPinned className="w-4 h-4 mr-2" /> Manual Planner
          </Button>
          ...
          <Card className="border-dashed border-2 border-slate-200 bg-slate-50/50">
            <CardContent className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <div className="flex gap-3 mt-6">
                <Button onClick={handleAddRoute} variant="outline" className="rounded-xl font-bold uppercase text-[10px] tracking-widest">
                  Create First Route
                </Button>
                <Button 
                  onClick={() => navigate(`/dashboard/budgets/transportation/ai-suggester/${id}`)}
                  className="bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-bold uppercase text-[10px] tracking-widest"
                >
