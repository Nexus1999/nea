      ...
      if (examCode === "FTNA") {
        return [
          ...
          { header: "District", accessor: "district", width: "w-[12%]" },
          {
            ...
            accessor: "tr",
            width: "w-[8%]",
            render: (label: LabelItem) => label.item === "TR" ? <span className="font-bold text-slate-800">{label.quantity<dyad-write path="src/pages/stationeries/LabelsManagementPage.tsx" description="Adding Supervisors Forms category for CSEE and ACSEE to process and pack TR and TWM using the same edge function and UI as FTNA.">
"use client";
