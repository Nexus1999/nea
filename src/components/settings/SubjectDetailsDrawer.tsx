          ...
          <div className="flex-1 overflow-y-auto py-6 space-y-8">
            <section className="space-y-4">
              <h3 className="text-xl font-bold text-gray-700 flex items-center gap-2">
                <BookOpen className="h-6 w-6 text-primary" /> General Information
              </h3>
            ...
            <section className="space-y-4">
              <h3 className="text-xl font-bold text-gray-700 flex items-center gap-2">
                <Calculator className="h-6 w-6 text-primary" /> Stationery Multipliers
              </h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white p-4 rounded-lg shadow-sm border hover:shadow-md transition-shadow duration-200">
            ...
            <section className="space-y-4">
              <h3 className="text-xl font-bold text-gray-700 flex items-center gap-2">
                <CalendarDays className="h-6 w-6 text-primary" /> Audit Information
              </h3>
              <div className="bg-white p-4 rounded-lg shadow-sm border hover:shadow-md transition-shadow duration-200">
